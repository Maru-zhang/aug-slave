...
//                a += ".html5zoo-img-box-" + this.id + " {display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;}";
            ...
            createArrows: function() {
                ...
                b.css({
                    ...
                    background: "url('" + this.options.skinsfolder + this.options.arrowimage_left + "') no-repeat left top",
                ...
                c.css({
                    ...
                    top: top + '%',
                    'margin-top': '-' + this.options.arrowheight / 2 + 'px',
                    background: "url('" + this.options.skinsfolder + this.options.arrowimage_right + "') no-repeat right top",
                    'background-size': '32px 32px',
                    'z-index':'1000'
                });
